...
<?php 
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link disabled" href="summa.php">CK x Summarecon Makassar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="#">Pusat</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="../bdg/bdgus.php">Bandung</a>
        </li>
        <li class="nav-item">
...
<tr>
 ...
 <th ><a href="viewmksus.php?id=<?php echo $data['id'];?>">Lihat File</a></th>
