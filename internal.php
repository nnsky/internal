...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="mks/mks.php">Makassar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="bdg/bdgadmin.php">Bandung</a>
        </li>
        <li class="nav-item">
...
<form style="padding-left: 1rem;" action="upload.php" method="POST" enctype="multipart/form-data">
