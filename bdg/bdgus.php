...
<?php 
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link disabled" href="../mks/mksus.php">Makassar</a>
        </li>
        <li class="nav-item">
...
<center>
<b style="font-size: 18px;">List File PDF</b>
...
<tr>
 ...
 <th ><a href="viewbdgus.php?id=<?php echo $data['id'];?>">Lihat File</a></th>
...
<img src="file/test.jpg" width="100px" alt=""></center>
