...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Internal Chandra Karya Bandung</a>
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link disabled" href="#">Makassar</a>
        </li>
        <li class="nav-item">
...
<form style="padding-left: 1rem;" action="uploadbdg.php" method="POST" enctype="multipart/form-data">
...
<tbody>
<?php
$query = mysqli_query($koneksi, "SELECT * FROM data_bdg ORDER BY id ASC");
...
<tr>
 ...
 <th ><a href="viewbdg.php?id=<?php echo $data['id'];?>">Lihat File</a></th>
 <th ><a href="hapusbdg.php?id=<?php echo $data['id'];?>">Hapus File</a></th>
</tr>
<?php
}
?>
